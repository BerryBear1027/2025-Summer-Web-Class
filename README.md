...
\
前端基于React+Vite框架，后端采用midway，利用npm进行托管\
由于个人知识匮乏，项目中难免出现各式各样的问题，成果粗糙🙂\
本项目具有完整开发流程存档，全程git上传，若有雷同，解释权归本人所有😡，禁止抄袭上传🤬\
**项目设计思路在wiki中，一定要看噢**\
[讲解视频链接](https://www.bilibili.com/video/BV1yY8BzgE9p/?vd_source=8dca3b15091ad396953cd6d0df255e46)\
[wiki链接](https://github.com/BerryBear1027/2025-Summer-Web-Class/wiki)\
[github项目主页](https://github.com/BerryBear1027/2025-Summer-Web-Class)\
...
`npm install`\
`npm run dev`\
然后进入前端给出的**local端口**即可进行注册和登陆操作以进入主页面\
如果要多用户运行，只需要再次打开一个新的页面就可以了，最简单的方法是再次点开终端给出的local端口链接注册登录\
\
PS:各处的**图片上传功能暂不可用**\
   **搜索功能**不止根据名称，还包括地点和介绍等内容，测试时请注意此点
